 ...
 *
 * This file contains a few functions that we use when the map is loading. We're 
 * loading the Map classes in post-loading frames, and as such during the loading
