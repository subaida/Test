...
import com.fusionmaps.helper.ScrollBar;
class com.fusionmaps.helper.Logger {
	...
	*/
	private function draw():Void {
		...
		isDrawn = true;
		//Create a context menu for logger
		//----------------------------------------------------------------------------------------------//
		var logMenu : ContextMenu = new ContextMenu ();
		logMenu.hideBuiltInItems ();
		//Create a show log context menu item
		var showCMI : ContextMenuItem = new ContextMenuItem ("Show Log", Delegate.create (this, show));
		//Push show item.
		logMenu.customItems.push (showCMI);
		//Create a hide log context menu item
		var hideCMI : ContextMenuItem = new ContextMenuItem ("Hide Log", Delegate.create (this, hide));
		//Push hide item.
		logMenu.customItems.push (hideCMI);
		//Create a clear log context menu item
		var clearCMI : ContextMenuItem = new ContextMenuItem ("Clear Log", Delegate.create (this, clearLog));
		//Push hide item.
		logMenu.customItems.push (clearCMI);
	...
	*/
	...
	/**
	 * resetSize method resizes the logger instance by redrawing it.
	 * @param	width	New chart width.
	 * @param	height	New chart height.
	*/
	public function resetSize(width:Number, height:Number):Void{
