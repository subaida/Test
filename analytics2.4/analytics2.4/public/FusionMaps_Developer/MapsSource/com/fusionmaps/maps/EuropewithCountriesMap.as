...
class com.fusionmaps.maps.EuropewithCountriesMap extends Map {
	//Version number (if different from super Map class)
	//private var _version:String = "3.0.0";
	//MapId represents the identifier name of the map movie clip
	private var mapId:String = "EuropewithCountriesMap";
	/**
	* Constructor function. We invoke the super class'
	* constructor and then set the objects for this map.
	*/
	function EuropewithCountriesMap(targetMC:MovieClip, depth:Number, width:Number, height:Number, x:Number, y:Number, debugMode:Boolean, lang:String ,scaleMode: String, registerWithJS: Boolean, DOMId:String) {
	...
	*/
	public function feedEntities() {
		...
		super.addEntity("047", "SC", "SC", "Scotland");
		super.addEntity("048", "EN", "EN", "England");
		super.addEntity("049", "WA", "WA", "Wales");
		super.addEntity("050", "NI", "NI", "North Ireland");
